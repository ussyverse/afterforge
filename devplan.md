...
| Guided workflow | Shared scan/review/draft/retained-check, pagination and reviewer controls integrated | Full packaged workflow and SQL scale checks passed; repeat after any change |
...
1. Preserve integrated changes and immutable evidence. AGENTS.md visibility was updated with explicit user authorization; preserve its other instructions. Review shared service/CLI/browser contracts against actual implementations.
